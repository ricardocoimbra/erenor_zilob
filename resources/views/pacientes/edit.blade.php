            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form class="row g-3" action="{{ route('patients.update', $patient ) }}" method="post">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="col-md-3">
                                ...
                                <input
                                    ...
                                    id="dt_nascimento"
                                    name="dt_nascimento"
                                    value="{{ old('dt_nascimento', $patient->dt_nascimento) }}"
                                >
                            ...
                            <div class="col-md-3">
                                ...
                                <input
                                    ...
                                    id="telefone"
                                    name="telefone"
                                    value="{{ old('telefone', $patient->telefone) }}"
                                >
                            ...
                            <div class="col-md-4">
                                ...
                                <input
                                    ...
                                    id="logradouro"
                                    name="logradouro"
                                    value="{{ old('logradouro', $patient->logradouro) }}"
                                >
                            ...
                            <div class="col-md-1">
                                ...
                                <input
                                    ...
                                    id="numero"
                                    name="numero"
                                    value="{{ old('numero', $patient->numero) }}"
                                >
                            ...
                            <div class="col-md-3">
                                ...
                                <input
                                    ...
                                    id="complemento"
                                    name="complemento"
                                    value="{{ old('complemento', $patient->complemento) }}"
                                >
